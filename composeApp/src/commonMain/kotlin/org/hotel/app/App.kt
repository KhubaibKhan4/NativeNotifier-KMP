...
import org.hotel.app.theme.AppTheme
import org.hotel.app.theme.LocalThemeIsDark
...
internal fun App() = AppTheme {
    ...
    Column(modifier = Modifier.fillMaxSize().windowInsetsPadding(WindowInsets.safeDrawing)) {
        ...
        if (isNotify){
            NativeNotifier("WELCOME TO MY LIBRARY, this is a Test Notification...")
        }
    }
}
...
@Composable
internal expect fun NativeNotifier(message: String)